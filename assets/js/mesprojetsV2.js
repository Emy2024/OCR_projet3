// Variante de code pour les filtres 🟣 : ici, nous utilisons la méthode Set pour retourner des valeurs uniques
...
//********************** Mes filtres avec la méthode Set 🟣 *******************//

const valeursUniques = [... new Set(tableauProjets.map(extraction => extraction.category.name))]
const filtreObjet = valeursUniques[0]
const filtreAppartement = valeursUniques[1]
const filtreHotelEtRestaurant = valeursUniques[2]
  ...
  if(tableauProjets[i].category.name === filtreObjet){
    buttonCategorieObjets.innerText = tableauProjets[i].category.name
  } 
  else if (tableauProjets[i].category.name === filtreAppartement){
    buttonCategorieAppartements.innerText = tableauProjets[i].category.name
  }
  else if (tableauProjets[i].category.name === filtreHotelEtRestaurant){
...
//************************** Mes filtres : créer une liste sans doublon avec Set **********************//